...
TEST_F(LoadBalancerTestFixture, ConstructWithInvalidEndpoint)
{
    EXPECT_THROW(std::ignore =
                     lb::LoadBalancer::Construct(ctx_(),
                                                 std::vector<Endpoint>{},
                                                 nullptr),
                 Exception);
    ...
    EXPECT_THROW(std::ignore = lb::LoadBalancer::Construct(
                     ctx_(),
...
TEST_F(LoadBalancerTestFixture, SimplePickAllServer)
{
...
TEST_F(LoadBalancerTestFixture, HealthCheckAllUnavailable)
{
    ...
    EXPECT_THROW(lb->PickAvailableServer(), Exception);
}
