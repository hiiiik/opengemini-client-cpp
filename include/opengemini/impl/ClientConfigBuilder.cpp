...
ClientConfig&& ClientConfigBuilder::Finalize() noexcept
{
...
OPENGEMINI_INLINE_SPECIFIER
ClientConfigBuilder&
ClientConfigBuilder::BatchConfig(std::chrono::seconds interval,
                                 std::size_t          size)
{
...
OPENGEMINI_INLINE_SPECIFIER
ClientConfigBuilder&
ClientConfigBuilder::ReadWriteTimeout(std::chrono::seconds timeout)
{
...
OPENGEMINI_INLINE_SPECIFIER
ClientConfigBuilder&
ClientConfigBuilder::ConnectTimeout(std::chrono::seconds timeout)
{
