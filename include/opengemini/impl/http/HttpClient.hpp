...
public:
    explicit HttpClient(std::chrono::seconds connectTimeout,
...
private:
    ...
    public:
        Pool(boost::asio::io_context& ctx, std::chrono::seconds connectTimeout);
...
private:
    HttpResponse SendRequest(const Endpoint&            endpoint,
                             HttpRequest                request,
